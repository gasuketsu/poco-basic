...
build() {
  ...
  cmake -DENABLE_DATA=OFF -DENABLE_NETSSL=OFF -DENABLE_MONGODB=OFF -DENABLE_PAGECOMPILER=OFF -DENABLE_CRYPTO=OFF -DENABLE_PAGECOMPILER_FILE2PAGE=OFF -DENABLE_ZIP=OFF ..
  make
}
